...
<html lang="pl">
	...
	<header>
		...
		<main id="content">
			...
			<form name="eks" action="./plForm.php" method="post">
				<fieldset>
					<legend>Importuj dane z istniejącej deklaracji dostępności</legend>
					<label for="url">Jeśli chcesz zaktualizować deklarację dostępności, podaj jej adres URL</label>
					<input type="url" name="url" id="url" aria-describedby="extractExc">
                    <small id="extractExc" aria-hidden="false">Sprawdź, czy automatycznie wypełniona pola mają prawidłowe wartości! Jeśli nie, musisz je poprawić!</small>
				</fieldset>
				<input type="submit" value="Importuj dane">
			</form>
			<form class="form" id="dod" method="post">
                ...
                <fieldset>
                    ...
                    <legend>Data przeglądu deklaracji</legend>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <label for="yearReview">Rok</label>
            ...
            <div>
                ...
                <label for="monthReview">Miesiąc</label>
                <select name="monthReview" id="monthReview">

                    <option value="1" <?php check_monthReview('1',$_session['option_monthReview']);?> >styczeń</option>
                    <option value="2" <?php check_monthReview('2',$_session['option_monthReview']);?> >luty</option>
                    <option value="3" <?php check_monthReview('3',$_session['option_monthReview']);?> >marzec</option>
                    <option value="4" <?php check_monthReview('4',$_session['option_monthReview']);?> >kwiecień</option>
                    <option value="5" <?php check_monthReview('5',$_session['option_monthReview']);?> >maj</option>
                    <option value="6" <?php check_monthReview('6',$_session['option_monthReview']);?> >czerwiec</option>
                    <option value="7" <?php check_monthReview('7',$_session['option_monthReview']);?> >lipiec</option>
                    <option value="8" <?php check_monthReview('8',$_session['option_monthReview']);?> >sierpień</option>
                    <option value="9" <?php check_monthReview('9',$_session['option_monthReview']);?> >wrzesień</option>
                    <option value="10" <?php check_monthDateOfMade('10',$_session['option_monthReview']);?> >październik</option>
                    <option value="11" <?php check_monthReview('11',$_session['option_monthReview']);?> >listopad</option>
                    <option value="12" <?php check_monthReview('12',$_session['option_monthReview']);?> >grudzień</option>
            ...
            <div>
                ...
                <label for="dayReview">Dzień</label>
